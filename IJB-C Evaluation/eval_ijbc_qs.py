...
# general
parser.add_argument('--image-path', default='/data/fboutros/IJB_release/IJB_release/IJBC', 
...
parser.add_argument('--quality-model', default='CRFIQAL', type=str, help='')
...
img_feats, faceness_scores, quality_scores= get_image_feature(img_path, files_list,
                                               modelname, 0, gpu_id, quality_dict)
stop = timeit.default_timer()
print('Time: %.2f s. ' % (stop - start))
